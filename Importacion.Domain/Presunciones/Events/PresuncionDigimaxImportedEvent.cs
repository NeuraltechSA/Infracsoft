...
public sealed record PresuncionDigimaxImportedEvent(
) : DomainEvent
{
    public required string PresuncionId { get; init; }
    public required string CompressedFileSourcePath { get; init; }
    ...
    public override string MessageName => "infracsoft.importacion.presunciones.presuncion_digimax_imported";
}
