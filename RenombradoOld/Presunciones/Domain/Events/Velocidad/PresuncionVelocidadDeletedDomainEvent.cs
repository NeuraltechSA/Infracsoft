...
namespace RenombradoOld.Presunciones.Domain.Events.Velocidad;

public sealed record PresuncionVelocidadDeletedDomainEvent(
) : DomainEvent
{
    ...
    public override string MessageName => "infracsoft.renombrado.presunciones.velocidad.deleted";
}